...
public class Dao {
  ...
  public List<Entity> getComments(Long postId) {
    //**Exercise**: get "Comments"
    //get all the comments for the given blog posts from the datastore 
    DatastoreService ds = DatastoreServiceFactory.getDatastoreService();
    //restrict to ancestor query for a given BlogEntry
    Key blogKey = KeyFactory.createKey("BlogEntry", postId);
    //new query for comment entities
